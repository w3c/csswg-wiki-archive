...
==== Process for New Tests ====
  ...
  - Once the test/changes has pass review, the reviewer should [[https://github.com/w3c/testtwf-website/blob/gh-pages/docs/test-templates.md#reviewer| note their acceptance in the test]] FIXME and re-submit the files to Mercurial. The commit message should indicate the test passed review and will be attached to the test in Shepherd.  The test status in Shepherd will then change to [[ http://test.csswg.org/shepherd/search/status/accepted|Accepted]]
