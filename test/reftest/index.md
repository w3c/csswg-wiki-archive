...
A *reftest* is a test that compares the visual output of one file (the testcase) with the output of one or more other files (the references). Unlike the standard [self-describing tests](/test/selftest/), reftests can be scripted to run and report results automatically.

A test can be both a [self-describing tests](/test/selftest/) and a reftest at the same time. This is preferable, since it allows for both machine comparison and manual verification--particularly useful if the test and the reference both render incorrectly in the same way!

> [!NOTE]
>
> Here is an example of a reftest that is also a self-describing test:
>
> ; [TEST](http://test.csswg.org/source/contributors/adobe/submitted/svg-transform/translate/svg-translate-001.html)
...
The test file uses the technology to be tested. This file must follow the [CSS test format guidelines](/format/).
...
Like the format for the test file, the reftest reference format is also XHTML or HTML5 in UTF-8 with bitmap images in PNG format. Unlike the format for the test file, there is no metadata except for the [author credits](/format#credits/) and optionally [reference links](/format#reference-links/), [reviewer information](/format#reviewer/), and [requirement flags](/format#requirement-flags/). [Specification links](/format#specification-links/) must NOT be present in reference files.
...
In order to designate which files are to be compared to the test file, and the nature of the comparison, the test file must have one or more links to the reference files [as described in the test format](/format#reference-links/).
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/c414-flt-000.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/float-001.htm

| [RC6] float-001]] **Reasons why**: Text flowing around a floated box is very difficult to reftest. |
| --- |

1. [[http://test.csswg.org/suites/css2.1/20110323/html4/float-002.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/c565-list-pos-001.htm

| [RC6] c565-list-pos-001]] **Reasons why**: list marker position |
| --- |

1. [[http://test.csswg.org/suites/css2.1/nightly-unstable/html4/c5524-height-000.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/c566-list-stl-001.htm

| [RC6] c566-list-stl-001]] **Reasons why**: list image position. |
| --- |

1. [[http://test.csswg.org/suites/css2.1/20110323/html4/c564-list-img-000.htm

| [RC6] c564-list-img-000]] **Reasons why**: list image position. |
| --- |

1. [[http://test.csswg.org/suites/css2.1/20110323/html4/c563-list-type-001.htm

| [RC6] c563-list-type-001]] **Reasons why**: list image position. |
| --- |

1. [[http://test.csswg.org/suites/css2.1/20110323/html4/c5510-padn-000.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/margin-collapse-164.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/floats-151.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/c5525-fltwrap-000.htm
...
1. [[http://test.csswg.org/suites/css2.1/nightly-unstable/html4/font-weight-016.htm
...
1. [[http://test.csswg.org/suites/css2.1/nightly-unstable/html4/font-size-118.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/line-height-applies-to-010.htm

| [RC6] line-height-applies-to-010]] **Reasons why**: list marker position |
| --- |

1. [[http://test.csswg.org/suites/css2.1/nightly-unstable/html4/font-size-119.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/c24-first-lttr-000.htm
...
1. [[http://test.csswg.org/suites/css2.1/nightly-unstable/html4/inherit-004.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/border-bottom-style-003.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/border-bottom-width-036.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/border-bottom-width-047.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/border-bottom-width-014.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/border-bottom-width-092.htm
...
1. [[http://test.csswg.org/suites/css2.1/nightly-unstable/html4/line-height-122.htm
...
1. [[http://test.csswg.org/suites/css2.1/nightly-unstable/html4/line-height-123.htm
...
1. [[http://test.csswg.org/suites/css2.1/nightly-unstable/html4/line-height-124.htm
...
1. [[http://test.csswg.org/suites/css2.1/nightly-unstable/html4/font-144.htm

| [nightly-unstable] font-144]] **Reasons why**: the test is specifically testing line-height: normal with Ahem font. |
| --- |

1. [[http://test.csswg.org/suites/css2.1/20110323/html4/c414-flt-wrap-000.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/c5522-brdr-002.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/floats-103.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/inlines-007.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/inlines-014.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/inlines-015.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/c5525-fltcont-000.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/margin-left-applies-to-008.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/padding-left-applies-to-008.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/padding-applies-to-008.htm

| [RC6] padding-applies-to-008]] **Reasons why**: Content area of an inline non-replaced element is based on the font type and font-size but the CSS2.1 specification does not specify how. So, the height of the orange borders is impossible to predict. Such difficulty applies as well to [[http://test.csswg.org/suites/css2.1/20110323/html4/margin-applies-to-008.htm | [RC6] margin-applies-to-008]] . With Ahem font, this would be computable and predictable. |
| --- | --- |

1. [[http://test.csswg.org/suites/css2.1/20110323/html4/abspos-003.htm

| [RC6] abspos-003]], [[http://test.csswg.org/suites/css2.1/20110323/html4/abspos-004.htm |
| --- |
| [RC6] abspos-004]] and [[http://test.csswg.org/suites/css2.1/20110323/html4/abspos-006.htm |
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/border-bottom-width-applies-to-014.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/dynamic-top-change-005.htm
...
| --- | --- |
| [RC6] dynamic-top-change-005a]] and  [[http://test.csswg.org/suites/css2.1/20110323/html4/dynamic-top-change-005b.htm | [RC6] dynamic-top-change-005b]] . |

1. [[http://test.csswg.org/suites/css2.1/20110323/html4/bottom-applies-to-008.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/position-relative-002.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/block-formatting-contexts-013.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/height-014.htm

| [RC6] height-014]] **Reasons why**: 'height: 1pt' is impossible to convert into a reftest as 1pt can be resolved as 1px (this is what Opera 12.02, Chrome 22.0.1229.79 and Konqueror 4.9.2 do) or as 2px (this is how Firefox 15.0.1 handles 1pt). Same kind of problem with [[http://test.csswg.org/suites/css2.1/20110323/html4/height-047.htm | [RC6] height-047]] ('height: 1mm') and other similar tests (height-036 and 1cm). |
| --- | --- |

1. [[http://test.csswg.org/suites/css2.1/20110323/html4/min-height-113.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/replaced-intrinsic-ratio-001.htm
...
1. [[http://test.csswg.org/suites/css2.1/20110323/html4/replaced-min-max-001.htm
