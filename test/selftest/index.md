...
- In some cases it is difficult or impossible to design the test for a glaringly obvious pass or fail. (In these cases, if it's possible to create a reference, the [reftest](/test/reftest/) format may be more appropriate.)

Self-describing tests must follow the [CSS test format guidelines](/format/).
