...
The CSS2.1 Conformance Test Suite tests conformance to the [[http://www.w3.org/TR/CSS21/|CSS2.1 specification]]. It is currently in the earlier stages of development, and is very incomplete. Additionally, some tests may be invalid due to changes in the spec. The [[http://www.w3.org/Style/CSS/Test/CSS2.1/|latest version]] is available on the W3C website. The [[http://test.csswg.org/|source files]] are available on the repository website. [[http://hg.csswg.org/test|Anonymous read-only Mercurial access]] is available to this repository. Note that many of the tests rely on the [[http://www.w3.org/Style/CSS/Test/Fonts/Ahem/|Ahem font]].

Discussion about the CSS2.1 Test Suite takes place on the publicly-archived [[http://lists.w3.org/Archives/Public/public-css-testsuite/|public-css-testsuite@w3.org]] mailing list.



=== CSS 2.1 Errata ===

Below are the tests that correspond to sections changed and included in the [[http://www.w3.org/Style/css2-updates/REC-CSS2-20110607-errata.html| CSS 2.1 Errata]]. These test should be reviewed for impact from the changes and clarifications. Existing test cases may be modified and adapted to the new spec language or new tests may be created where there is lack of coverage. 
...
| **s.4.1.1a** \\ **s.G.2d** | change \\ clarification | [[http://www.w3.org/TR/2011/REC-CSS2-20110607/syndata.html#tokenization| 4.1.1 Tokenization]] \\ [[http://www.w3.org/TR/2011/REC-CSS2-20110607/grammar.html#scanner| G.2 Lexical scanner]]| Tab | 0 | | Needs a test |
| **s.4.1.1b** \\ **s.4.1.3d** | change \\ change| [[http://www.w3.org/TR/2011/REC-CSS2-20110607/syndata.html#tokenization| 4.1.1 Tokenization]] \\ [[ http://www.w3.org/TR/2011/REC-CSS2-20110607/syndata.html#characters| 4.1.3 Characters and case]] | Tab | 0 | | Needs tests for valid and invalid cases |
...
Here are the current set of issues that need attention in order to fulfill the release criteria:
  ...
  * [[test:css2.1:incorrect| NeedsWork=Incorrect]]  | [[http://test.csswg.org/shepherd/search/spec/CSS21/status/issue/whiteboard/Incorrect%20-%20Precision|Shepherd Query]]
  * [[test:css2.1:precision|NeedsWork=Precision]]  | [[http://test.csswg.org/shepherd/search/spec/CSS21/status/issue/whiteboard/Precision%20-%20Incorrect|Shepherd Query]]
  * [[test:css2.1:incorrect-precision|NeedsWork=Precision + NeedsWork=Incorrect]]  | [[http://test.csswg.org/shepherd/search/spec/CSS21/status/issue/whiteboard/Precision%20and%20Incorrect/|Shepherd Query]]
  * Resubmitted for Review  - any tests from the lists above that have been address | [[http://test.csswg.org/shepherd/search/spec/CSS21/status/resubmitted/|Shepherd Query]]
  * [[test:css2.1:rejected|Rejected]] | [[http://test.csswg.org/shepherd/search/spec/CSS21/status/rejected/|Shepherd Query]]
  * [[test:css2.1:update-guidelines|Guidelines for updating tests]]  
...
// 12/4/2012 Note:  The information below pertains to efforts prior to the 2.0 Test Suite planning and may not be current. The current set of issues is listed above //
  * [[test:css2.1:issues|Known Bugs]] all kinds of problems
  * [[test:css2.1:invalid|Invalid Tests]] tests that have been reported invalid
  * [[test:css2.1:blocking|Blocking Tests]] tests that block REC due to insufficient passes
  * [[test:css2.1:need-data|Tests Needing Data]] tests that do not have sufficient data, may be blocking
  * [[test:css2.1:results|Test Results With Notes]] test result analysis from Fall 2010
  * [[test:css2.1:assertions|Test Assertions List]]
  * [[test:css2.1:pending|Tests Pending Review]]