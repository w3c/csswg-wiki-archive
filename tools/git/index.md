...
You need to first [install git on your system](/tools/git/install/), if you haven't already. We recommend using the latest client.
...
Access to the repositories on dvcs.w3.org is controlled by your W3C user account. If you're not a member of the appropriate group and need write access, please email [Peter](/mailto/peter.linss@hp.com/) or [sysreq](/mailto//sysreq@w3.org/).

## Working With Mercurial

Once you have a created a working directory by cloning the central repository onto your machine, you are free to edit the files in the working directory with your favorite tools. Mercurial will automatically detect edits made to any files within your working directory. However, when moving, renaming, copying, or deleting files, these operations need to be done [via Mercurial](/#manging-files/) rather than your standard operating system operations. This enables Mercurial to track those changes in addition to edits within the files.
...
1. Make edits in my working directory
1. Commit my work into my local repository
1. Send my changes back to the central repository
...
- [Examining Your Changes](/#examining-your-changes/)
  - [Listing Changed Files: hg status](/#listing-changed-fileshg-status/)
  - [Diffs and Patches: hg diff](/#diffs-and-patcheshg-diff/)
  - [Reverting Changes: hg revert](/#reverting-changeshg-revert/)
- [Synchronizing Changes](/#synchronizing-changes/)
  - [Updating Your Repository: hg pull](/#updating-your-repositoryhg-pull/)
  - [Submitting Your Changes: hg commit and hg push](/#submitting-your-changeshg-commit-and-hg-push/)
  - [Merging Branches of Work: hg merge](/#merging-branches-of-workhg-merge/)
  - [Resolving Conflicts: hg resolve](/#resolving-conflictshg-resolve/)
- [Managing Files](/#managing-files/)
  - [Adding New Files: hg add](/#adding-new-fileshg-add/)
  - [Removing Files: hg remove](/#removing-fileshg-remove/)
  - [Moving and Renaming Files: hg move](/#moving-and-renaming-fileshg-move/)
  - [Copies and Forks: hg copy](/#copies-and-forkshg-copy/)
...
- [Archaeology](/#archaeology-and-travelling-through-time/)

### Examining Your Changes

This section covers:

- [Listing Changed Files](/#listing-changed-fileshg-status/)
- [Diffs and Patches](/#diffs-and-patcheshg-diff/)
- [Reverting Changes](/#reverting-changeshg-revert/)
...
This section covers:
- [Updating Your Repository](/#updating-your-repositoryhg-pull/)
- [Submitting Your Changes](/#submitting-your-changeshg-commit-and-hg-push/)
- [Merging Branches of Work](/#merging-branches-of-workhg-merge/)
- [Resolving Conflicts](/#resolving-conflictshg-resolve/)
...
:?: If you have locally-committed changes that you haven't yet pushed to the server, you might see a message about multiple "heads". In this case you need to `hg merge`. See [Merging](/#merging-branches-of-workhg-merge/), below.
...
This section covers:
- [Adding New Files](/#adding-new-fileshg-add/)
- [Removing Files](/#removing-fileshg-remove/)
- [Moving and Renaming Files](/#moving-and-renaming-fileshg-move/)
- [Copies and Forks](/#copies-and-forkshg-copy/)
...
If you're stuck, you can [email Peter](/mailto/peter.linss@hp.com/) for help with the repository.
