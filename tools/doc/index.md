---
title: "Disposition of Comments tool"
---

# Disposition of Comments tool
...
The app itself is made with [Mavo](https://mavo.io/), and is therefore entirely defined via HTML and CSS, so it's very easy to change if e.g. you need an extra field or filter.

## How to adapt the tool for a different WG
...
- Edit issues.html and change `w3c/csswg-drafts` in `mv-storage` to your WG’s repo (e.g. `w3c/ttml2`)
- Edit the title “CSS WG Disposition of Comments” to something that is relevant to your WG
