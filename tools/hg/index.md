---
title: "Quick Guide To Using Mercurial"
---
...
You need to first [install Mercurial on your system](../../tools/hg/install/ "tools:hg:install"), if you haven't already. Our server is running version 3.2.1. Earlier versions should work, but we recommend using the latest client.
...
>
> Depending on your OS and Mercurial root certificate configuration you may get a warning message about the host certificate when communicating with the central repository. If that happens, please see [the instructions on the Mercurial wiki](https://www.mercurial-scm.org/wiki/CACertificates#Configuration_of_HTTPS_certificate_authorities).
...
- [Examining Your Changes](#examining-your-changes "tools:hg ↵")
  - [Listing Changed Files: hg status](#listing-changed-fileshg-status "tools:hg ↵")
  - [Diffs and Patches: hg diff](#diffs-and-patcheshg-diff "tools:hg ↵")
  - [Reverting Changes: hg revert](#reverting-changeshg-revert "tools:hg ↵")
- [Synchronizing Changes](#synchronizing-changes "tools:hg ↵")
  - [Updating Your Repository: hg pull](#updating-your-repositoryhg-pull "tools:hg ↵")
  - [Submitting Your Changes: hg commit and hg push](#submitting-your-changeshg-commit-and-hg-push "tools:hg ↵")
  - [Merging Branches of Work: hg merge](#merging-branches-of-workhg-merge "tools:hg ↵")
  - [Resolving Conflicts: hg resolve](#resolving-conflictshg-resolve "tools:hg ↵")
- [Managing Files](#managing-files "tools:hg ↵")
  - [Adding New Files: hg add](#adding-new-fileshg-add "tools:hg ↵")
  - [Removing Files: hg remove](#removing-fileshg-remove "tools:hg ↵")
  - [Moving and Renaming Files: hg move](#moving-and-renaming-fileshg-move "tools:hg ↵")
  - [Copies and Forks: hg copy](#copies-and-forkshg-copy "tools:hg ↵")
- [Working Offline](#working-offline "tools:hg ↵")
  - [Pull vs. Update](#pull-vs-update "tools:hg ↵")
  - [Commit vs. Push](#commit-vs-push "tools:hg ↵")
  - [Patch Queues](#patch-queues "tools:hg ↵")
  - [Rebasing Changesets](#rebasing-changesets "tools:hg ↵")
  - [Comparing Repositories](#comparing-repositories "tools:hg ↵")
- [Archaeology](#archaeology-and-travelling-through-time "tools:hg ↵")

### Examining Your Changes

This section covers:

- [Listing Changed Files](#listing-changed-fileshg-status "tools:hg ↵")
- [Diffs and Patches](#diffs-and-patcheshg-diff "tools:hg ↵")
- [Reverting Changes](#reverting-changeshg-revert "tools:hg ↵")
...
See [Managing Files](#managing-files "tools:hg ↵") for adding, removing, and moving files with Mercurial.
...
- [Updating Your Repository](#updating-your-repositoryhg-pull "tools:hg ↵")
- [Submitting Your Changes](#submitting-your-changeshg-commit-and-hg-push "tools:hg ↵")
- [Merging Branches of Work](#merging-branches-of-workhg-merge "tools:hg ↵")
- [Resolving Conflicts](#resolving-conflictshg-resolve "tools:hg ↵")
...
- [Adding New Files](#adding-new-fileshg-add "tools:hg ↵")
- [Removing Files](#removing-fileshg-remove "tools:hg ↵")
- [Moving and Renaming Files](#moving-and-renaming-fileshg-move "tools:hg ↵")
- [Copies and Forks](#copies-and-forkshg-copy "tools:hg ↵")
