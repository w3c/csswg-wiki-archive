...
You need to first [install Mercurial on your system](/tools/hg/install/), if you haven't already. Our server is running version 3.2.1. Earlier versions should work, but we recommend using the latest client.
