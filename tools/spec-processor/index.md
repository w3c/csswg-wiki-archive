...
Unless you're editting one of the handful of very old specs that haven't been converted to [Bikeshed](http://wiki.csswg.org/tools/bikeshed), you don't need any of the information on this page.
...
1. Click (Choose File) and select the `Overview.src.html` file on your local machine that you want to post-process (you should do this when you're ready to check it in).
1. Choose (*) Generated HTML - radio button
