...
This page is preserved out of historical interest, but the guidance and rules it suggests are NOT the policy of the CSS Working Group. After much discussion (and this page is part of that discussion), the CSSWG adopted a different set of guidelines, as recorded in [section 3.2 of the CSS 2015 Snapshot](http://www.w3.org/TR/CSS/#future-proofing)

# CSS Vendor Prefixes

In CSS we use [vendor prefixes](http://www.w3.org/wiki/Evolution/Identifiers) for properties, values, @-rules that are:

- [vendor specific extensions (per CSS 2.1)](http://www.w3.org/TR/CSS21/syndata.html#vendor-keywords), or
- [experimental implementations (per CSS Snapshot 2010)](http://www.w3.org/TR/css-2010/#experimental) (e.g. in Working Drafts)
...
- 2012 May:
  - [Policy change](http://lists.w3.org/Archives/Public/www-style/2012May/0125.html) (after [Opera’s start of defection](http://dev.opera.com/articles/view/opera-mobile-emulator-experimental-webkit-prefix-support/))
  - [replacement by ''!tag''](http://lists.w3.org/Archives/Public/www-style/2012Apr/0797.html)
- 2012 February: okay to implement competitor’s prefix?
  - [common ''-css-'' prefix](http://lists.w3.org/Archives/Public/www-style/2012Feb/1169.html)
  - [proprietary vs. experimental implementations](http://lists.w3.org/Archives/Public/www-style/2012Feb/0998.html)
  - [diverge from standard process to avoid more harm](http://lists.w3.org/Archives/Public/www-style/2012Feb/0678.html)
  - [opt-out vs. opt-in](http://lists.w3.org/Archives/Public/www-style/2012Feb/0472.html) after [Remy Sharp](http://remysharp.com/2012/02/09/vendor-prefixes-about-to-go-south/)
  - [Tantek Çelik](https://wiki.mozilla.org/Platform/Layout/CSS_Compatibility#questions_and_methodology)
  - [Daniel Glazman](http://www.glazman.org/weblog/dotclear/?post/2012/02/09/CALL-FOR-ACTION:-THE-OPEN-WEB-NEEDS-YOU-NOW)
  - [unlock with @-switches](http://lists.w3.org/Archives/Public/www-style/2012Feb/0463.html) after [Felipe](http://felipe.wordpress.com/2012/02/02/a-proposal-to-drop-browser-vendor-prefixes/)
  - [F2F minutes](http://lists.w3.org/Archives/Public/www-style/2012Feb/0313.html)
- 2012 January: [prefix features from other W3C WGs?](http://lists.w3.org/Archives/Public/www-style/2012Jan/1316.html)
- 2011 December: [versioned common prefixes](http://lists.w3.org/Archives/Public/www-style/2011Dec/0155.html)
- 2011 November:
  - [Cocascade](http://lists.w3.org/Archives/Public/www-style/2011Nov/0346.html)
  - [Pragmatic unprefixing](http://lists.w3.org/Archives/Public/www-style/2011Nov/0271.html)
  - [Henri Sivonen](http://hsivonen.iki.fi/vendor-prefixes/)
- …
...
- SHOULD ([per CSS-snapshot-2010](http://www.w3.org/TR/css-2010/#experimental)) use a vendor-specific prefix for the implementation of the feature
...
- SHOULD ([per CSS-snapshot-2010](http://www.w3.org/TR/css-2010/#experimental)) support an unprefixed version of the feature
  - suggest this be changed to a MUST. - Tantek
...
- SHOULD consider dropping the vendor-specific prefixed version of the feature.
  - [Eric Meyer’s article on the topic at A List Apart](http://www.alistapart.com/articles/prefix-or-posthack/) raised a [discussion at www-style](http://lists.w3.org/Archives/Public/www-style/2010Jul/0048.html) in 2010
...
This is a [list of known prefixes](http://www.w3.org/TR/CSS2/syndata.html) from vendors and third parties. Implementers MUST NOT use them unless licensed by a condition above.
