...
Issues raised, resolved, and closed for [CSS3 color](../../../spec/css3-color/ "spec:css3-color").
...
Summary
: css3-color should have a useful index or it should be removed
...
URL
: http://lists.w3.org/Archives/Public/www-style/2008Mar/0405.html http://lists.w3.org/Archives/Public/www-style/2008Mar/0443.html http://lists.w3.org/Archives/Public/www-style/2008May/0182.html http://lists.w3.org/Archives/Public/www-style/2008Aug/0013.html http://lists.w3.org/Archives/Public/www-style/2008Aug/0019.html

Reporter's response to resolution
: http://lists.w3.org/Archives/Public/www-style/2008Oct/0229.html

Further discussion
: http://lists.w3.org/Archives/Public/www-style/2008Oct/0230.html http://lists.w3.org/Archives/Public/www-style/2010Sep/0841.html

Proposed Resolution 1
: no change, to preserve section number stability

Proposed Resolution 2
: similar to what is proposed, but moving the gamma correction section (probably modified, per later issue) into the beginning of Color Units, and perhaps putting the units before the values

Status
: resolved to make no change, http://lists.w3.org/Archives/Public/www-style/2008Sep/0169.html

### Issue 3

Summary
: rename sections giving color keywords

Raised by
: various

URL
: http://lists.w3.org/Archives/Public/www-style/2008May/0146.html

Proposed Resolution
: Probably rename, given the confusion this has caused

Status
: draft sections renamed per above URL to “Basic color keywords” and “Extended color keywords”
...
Note
: same as issue 20 on previous issues list
...
Summary
: presentation of HTML4 keywords and SVG keywords is inconsistent
...
Proposed Resolution
: change HTML4 table to look like SVG Table
...
Proposed Resolution
: no change, since they wouldn't be exact matches due to rounding issues, and then there would be ambiguity
...
Summary
: Is HSL full range or video range?
...
Reporter's response to resolution
: http://lists.w3.org/Archives/Public/www-style/2010Sep/0845.html
...
Note
: same as issue 17 on previous issues list, due to insufficient editing the previous time around
...
Summary
: note pointing to appearance property should link to it
...
Summary
: Mac OS X changing gamma, recommendations obsolete

Raised by
: Chris Murphy

URL
: http://lists.w3.org/Archives/Public/www-style/2009Jul/0171.html http://lists.w3.org/Archives/Public/www-style/2009Oct/0189.html http://lists.w3.org/Archives/Public/www-style/2009Oct/0190.html http://lists.w3.org/Archives/Public/www-style/2009Oct/0191.html http://lists.w3.org/Archives/Public/www-style/2009Oct/0215.html

Resolution
: section already removed to resolve issue 8
...
Summary
: computed value of system colors should be a color, not the keyword itself
...
Summary
: “predefined” doesn't make sense in context (used twice)
...
Summary
: sRGB reference needs to be updated, check other references too
...
IEC 61966-2-1: 1999: Multimedia systems and equipment — Colour measurement and management — Part 2-1: Colour management — Default RGB colour space — sRGB, International Electrotechnical Commission, 1999. ISBN 2-8318-4989-6 as ammended by Amendment A1:2003. Available at <http://webstore.iec.ch/webstore/webstore.nsf/artnum/025408> and at <http://www.colour.org/tc8-05/Docs/colorspace/61966-2-1.pdf> .
...
Reporter's response to resolution
: http://lists.w3.org/Archives/Public/www-style/2010Sep/0857.html

Proposed Resolution
: no change for CSS3, consider for later specification
...
Reporter's response to resolution
: http://lists.w3.org/Archives/Public/www-style/2010Oct/0076.html
...
Reporter's response to resolution
: http://lists.w3.org/Archives/Public/www-style/2010Oct/0116.html

Proposed Resolution
: edit references following guidance from Alan Robertson, Chair, CIE TC 1-57
...
- [CSS3 Color main page](../../../spec/css3-color/ "spec:css3-color")