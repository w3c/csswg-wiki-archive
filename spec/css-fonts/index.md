...
1. Because *generic font families* are only relevant for *pre-installed fonts*, common configurations of at least two major platforms (operating systems with distinct GUIs) need to ship a font which would be mapped to this *generic font family*. Again, "distinct" requires that the platforms are maintained by different unaffiliated groups. The font shipped may be the same nevertheless.
