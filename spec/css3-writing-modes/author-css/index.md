...
Any corrections, additional information, opinions, questions, please let [me](/mailto/kojiishi@gmail.com/) know.
...
1. Mongolian is a vertical script, but technically it has very similar characteristics to horizontal scripts in vertical flow, so the use of the text-orientation property is strongly recommended. See [Horizontal Only Scripts](/author-css#horizontal-only-scripts/) below for more details of this property.
