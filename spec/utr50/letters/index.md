...
Letters and script-specific (non-Common) numbers are classified by using their script property (including [Script Extensions property](http://www.unicode.org/Public/UNIDATA/ScriptExtensions.txt)). [Common numbers](/numbers/) are listed separately.
...
| --- | --- | --- | --- | --- | --- | --- |
| [[http://www.fileformat.info/info/unicode/char/30FC/index.htm | U+30FC]] | KATAKANA-HIRAGANA PROLONGED SOUND MARK | ー | T<sub>R</sub> | T<sub>R</sub> |  |
| [[http://www.fileformat.info/info/unicode/char/FF70/index.htm | U+FF70]] | HALFWIDTH KATAKANA-HIRAGANA PROLONGED SOUND MARK | ｰ | T<sub>R</sub> | R | :?: Halfwidth? |
...
See also [Symbols from this block](/spec/utr50/symbols/textual/) and [Math symbols from this block](/spec/utr50/symbols/math/)
