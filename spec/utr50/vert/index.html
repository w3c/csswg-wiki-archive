===== vert =====
  ...
  * MVO values are "[[vert20120606|draft#5 + Consolidated feedback, rev 5]]" + discussed with fantasai
...
|Simplified Chinese|SimSun|Microsoft YaHei|
  ...
  * Fonts may have different vert table depends on its versions.
    ...
    * Chinese doesn't require as many code points to be transformed as Japanese does, so they used to rely on vertical presentation forms in [[http://www.unicode.org/charts/PDF/UFE10.pdf|FE10-FE1F]] and [[http://www.unicode.org/charts/PDF/UFE30.pdf|FE30-FE44/FE47-FE48]] rather then vert.
  * [[http://en.wikipedia.org/wiki/List_of_Microsoft_Windows_fonts|Full list of Windows standard fonts is available in wikipedia]]
