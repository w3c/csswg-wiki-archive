...
This page started from the initial [[http://dev.w3.org/csswg/css3-exclusions//|CSS Exclusions and Shapes editor draft]].

[[ideas:css3-exclusions-use-cases|CSS Exclusions and Shapes Use Cases]]

[[ideas:css3-exclusions-print-use-cases|CSS Exclusions and Shapes Use Cases from Print Sources]]
...
[[http://lists.w3.org/Archives/Public/www-style/2012Feb/0325.html|Paris FTF February 2012 Tuesday]]

  * ✔ Resolved: Adopt the [[http://wiki.csswg.org/ideas/functional-notation|proposed]] changes to Exclusions therein except for the suggestion to unify rect() and rectangle().
===== Action Items =====

Action items and issues for CSS3 Exclusions are maintained on Bugzilla:

[[https://www.w3.org/Bugs/Public/buglist.cgi?product=CSS&component=CSS%20Exclusions&resolution=---|CSS3 Exclusions Bugs]]