---
title: "Use Cases from Print Layouts for Regions"
---
...
![](../../../assets/images/spec/css3-regions/column-widths.png)
...
![](../../../assets/images/spec/css3-regions/2reg_1excl.png)
...
![](../../../assets/images/spec/css3-regions/2regions.png)

\<HTML\>\<div style=“margin: auto ; width: 50%”\>\<p\>The screenshot and link above show a document made of two articles interleaved. The document starts with region 1 of article 1, then region of article 2, a page of advertisement, then region 2 of article 1 and finally region 2 of article 2. Some of these regions are rendered in columns but that's only for consistency with the original document copied here. Controls are available in the top-left corner to increase or decrease the font size of the articles and the width of the content area.\</p\> \<p\>The demo works in Chrome 19 with the CSS Regions features turned on.\</p\> \<p\>The original paper version is \<a href=“<http://www.cxvascular.com/sn-newspaper-pdfs?DocumentScreen=detail&cl=352&ccs=673>”\>issue 20 of Spinal News\</a\> and is shown in three pages below.\</p\>\</div\> \</HTML\>

![](../../../assets/images/spec/css3-regions/20-1.png) ![](../../../assets/images/spec/css3-regions/20-3.png) ![](../../../assets/images/spec/css3-regions/20-4.png)

#### Templates with multiple flows

![](../../../assets/images/spec/css3-regions/expo-nentiell-page-1.png) ![](../../../assets/images/spec/css3-regions/expo-nentiell-page-2.png)
