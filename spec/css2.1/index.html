...
==== Issue 185 ====
  ...
  ;Resolution : Proposal accepted with modifications as written in the [[http://lists.w3.org/Archives/Public/www-style/2010Aug/0185.html|minutes]]
  ;Status : Closed.
  ;Testcases : float-006
...
The following are known problems in the [[http://www.w3.org/TR/2009/CR-CSS2-20090908/|8 September 2010 CSS2.1 Candidate Recommendation]]. The resulting changes and corrections have been incorporated into the [[http://www.w3.org/TR/2010/WD-CSS2-20101207/|7 December 2010 LCWD]].

**These issues are intermixed in the April 2009 section. :(**

===== 23 April 2009 CR Issues =====

The following are known problems in the [[http://www.w3.org/TR/2009/CR-CSS2-20090423/|23 April 2009 CSS2.1 Candidate Recommendation]]. The resulting changes and corrections have been incorporated into the [[http://www.w3.org/TR/2009/CR-CSS2-20090908/|8 September 2010 CSS2.1 Candidate Recommendation]].
...
==== Issue 2 ====
  ...
  ;Summary : Remove ''DELIM?'' from ''declaration'' definition in 4.1.1. (It was [[http://lists.w3.org/Archives/Member/w3c-css-wg/2003JanMar/0273.html|added there]] to enable vendor extensions, but that's already solved by allowing hyphens at the beginning of an identifier.)
...
==== Issue 5 ====
  ...
  ;Summary : Descendant combinator should be represented as ''S+'' in grammar instead of ''S''. (This correction matches grammar in [[http://www.w3.org/TR/css3-selectors/#grammar|(CSS3) Selectors]].)
...
http://lists.w3.org/Archives/Member/w3c-css-wg/2007JulSep/0177.html
  ...
  ;Proposal : In [[http://www.w3.org/TR/CSS21/box.html#collapsing-margins|8.3.1]] bullet 6 subbullet 2, change "non-zero top border" to "non-zero bottom border".
  ;Resolution : Proposal accepted.
  ;Status : Closed.
...
==== Issue 19 ====
  ...
  ;Resolution : [[http://www.w3.org/blog/CSS/2007/12/12/case_sensitivity|Proposal accepted.]]
  ;Status : Closed.
...
==== Issue 108 ====
  ...
  ;Status : [[http://lists.w3.org/Archives/Public/www-style/2009Mar/0247.html|Closed.]]
