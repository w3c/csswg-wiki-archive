...
=== new cursor values ===
  * new 'cursor' values:
    * 'auto-hide' - being added to WebKit as [[https://bugs.webkit.org/show_bug.cgi?id=107601|-webkit-auto-hide]], see [[http://lists.w3.org/Archives/Public/www-style/2013Feb/0194.html|this www-style thread]]
...
Consider adding a new 'caret' property.
  * [[http://lists.w3.org/Archives/Public/www-style/2011Nov/0772.html|Proposed by Lea Verou]]
<code>
Name: caret
...
Implementer feedback:
  * "[[http://lists.w3.org/Archives/Public/www-style/2011Nov/0775.html|would be easy in Gecko]]"
  * ...
...
==== more selectors ====
  ...
  * ::placeholder pseudo-element for the placeholder content inside an input element with a placeholder attribute.
    * There's an empty documentation page for [[https://developer.mozilla.org/en-US/docs/CSS/::-moz-placeholder|::-moz-placeholder]] which is implemented as of Firefox 19.
  * :placeholder-shown pseudo-class for when an input element is in the state of showing its placeholder text
    * See [[ideas/placeholder-styling|placeholder styling]] for more detailed exploration of :placeholder vs. ::placeholder (or potentially both). 
    * [[https://developer.mozilla.org/en/CSS/%3a-moz-placeholder|:-moz-placeholder]] documentation ([[https://developer.mozilla.org/en-US/docs/Web/CSS/::-moz-placeholder|deprecated in FF19]])
    * [[https://bugzilla.mozilla.org/show_bug.cgi?id=457801|Mozilla bug 457801]]:  Implement -moz-placeholder pseudo-class - big long discussion of pseudo-class vs. pseudo-element etc.
  * [[https://wiki.mozilla.org/CSS/:autofill|:autofill]] pseudo-class for when an input element is in the state of showing an autofilled value. Related implementer bugs (not yet implemented) :
    * [[https://bugzilla.mozilla.org/show_bug.cgi?id=740979|:-moz-autofill]] implementation bug
    * [[https://bugs.webkit.org/show_bug.cgi?id=66032|:-webkit-autofill]] implementation bug
  * [[https://developer.mozilla.org/en-US/docs/CSS/:-moz-broken|:broken]] for elements representing broken image links. See also Mozilla bug [[https://bugzilla.mozilla.org/show_bug.cgi?id=11011|11011]].
  * [[https://developer.mozilla.org/en-US/docs/CSS/:-moz-user-disabled|:user-disabled]] matches elements representing images that were not loaded because images have been entirely disabled by the user's preferences
  * [[https://developer.mozilla.org/en-US/docs/CSS/:-moz-suppressed|:suppressed]] for elements representing images that were not loaded because loading images from that site has been blocked.
  * [[https://developer.mozilla.org/en-US/docs/CSS/:-moz-loading|:loading]] for elements none of which can be displayed because they have not started loading, such as images that haven't started to arrive yet.  Note that images that are in the process of loading are not matched by this pseudo-class.
...
Consider adding a 'paint-order' value, as per [[http://lists.w3.org/Archives/Public/www-style/2013Jun/0245.html|Tokyo 2013 discussion]]
...
Microsoft has shipped support for "touch-action" in prefixed form in IE10:
  * [[http://msdn.microsoft.com/en-us/library/windows/apps/hh767313.aspx|-ms-touch-action property (Windows)]]
...
Also see:
  * [[http://lists.w3.org/Archives/Public/www-style/2013Oct/thread.html#msg624|discussion in October 2013]]
