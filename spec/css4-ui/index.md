...
- :placeholder-shown pseudo-class for when an input element is in the state of showing its placeholder text
  - See [placeholder styling](/ideas/placeholder-styling/) for more detailed exploration of :placeholder vs. ::placeholder (or potentially both). 
...
nav-index:
- See issues [nav-index](/ideas/nav-index/)
