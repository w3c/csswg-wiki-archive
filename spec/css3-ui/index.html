...
==== Steps to PR ====
  * √ Publish draft as [[http://lists.w3.org/Archives/Public/www-style/2015Jan/0406.html|resolved in 2005-01-21 telcon]]
...
General steps in rough order:
  ...
  * Make spec edits for resolved issues, then move them to https://www.w3.org/wiki/CSS3-UI
    ...
    * use https://api.csswg.org/bikeshed/ per [[https://wiki.csswg.org/tools/bikeshed#using-the-web-form|instructions]] to generate spec view HTML
...
===== Current Issues =====
The following are open issues in/with the [[http://www.w3.org/TR/2012/WD-css3-ui-20120117/|17 Jan 2012 CSS3-UI Working Draft]], and/or the latest [[http://dev.w3.org/csswg/css3-ui/|CSS3-UI Editor's Draft]].
