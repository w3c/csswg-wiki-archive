...
1. resolutions about issues that were in the specification

This page started from the initial [CSS Fragmentation editor draft](http://dev.w3.org/csswg/css3-break//).

[CSS Fragmentation Use Cases](/ideas/css3-break-use-cases/)
