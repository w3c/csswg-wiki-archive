...
<title>CSS Fragmentation Page - CSS Working Group Wiki (Archive)</title>
<style>
...
<div class="breadcrumb"><a href="../../">Home</a> / <a href="../../spec/">spec</a> / css3-break</div>
<main>
<!-- TOC START -->
...
<ul class="toc">
<li class="level2"><a href="#css-fragmentation-page">CSS Fragmentation Page</a></li>
...
<h2 id="css-fragmentation-page">CSS Fragmentation Page</h2>
<p>
...
<p>
This page started from the initial <a href="http://dev.w3.org/csswg/css3-break//" title="http://dev.w3.org/csswg/css3-break//" rel="noopener">CSS Fragmentation editor draft</a>.
</p>

<p>
<a href="../../ideas/css3-break-use-cases/" title="ideas:css3-break-use-cases" rel="nofollow">CSS Fragmentation Use Cases</a>
</p><h2 id="spec-and-test-metadata">Spec and Test Metadata</h2>
<p>
Each of the <abbr title="Cascading Style Sheets">CSS</abbr> Fragmentation tests will have metadata that points back one or more ids used in the Fragmentation <abbr title="specification">spec</abbr>. These ids may be heading or dfn elements, or they may be ids added at the paragraph or sentence level to indicate a specific conformance requirement that must be tested. We should be able to scan the <abbr title="specification">spec</abbr> for ids (ignoring non-testable ids) and find at least one test for every testable id in the <abbr title="specification">spec</abbr>.
</p>
