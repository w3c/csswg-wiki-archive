...
- [GitHub issues](https://github.com/w3c/csswg-drafts/issues) (preferred)
- [Wiki](/spec/) (fantasai notes from experience that if you track all issues in one page, it will eventually get [unweildy](/spec/css2.1/), so consider a method for using sub-pages)
- [Tracker](http://w3.org/Style/CSS/Tracker/) (historical)
- [Bugzilla](http://www.w3.org/Bugs/Public/) (historical)
- Inline in the spec itself (please avoid for non-trivial issues)

Each spec has a link in its header to where issues are tracked for the draft (e.g. see "Issues List:" in header of [CSS3-UI editor's draft](http://dev.w3.org/csswg/css3-ui/)). If all issues are tracked in the draft itself, this points to the editor's draft.
...
The level of WG oversight on a spec [depends on its maturity](http://fantasai.inkedblade.net/weblog/2011/inside-csswg/process): the closer a spec is to REC, the less leeway the editor has for making unilateral decisions.
...
1. Request confirmation that the proposed resolution is OK.

Good examples (better examples would link to the issue):
- http://lists.w3.org/Archives/Public/www-style/2012Feb/0269.html
- http://lists.w3.org/Archives/Public/www-style/2010Oct/0829.html
- http://lists.w3.org/Archives/Public/www-style/2010Sep/0066.html

Bad examples:
- http://lists.w3.org/Archives/Public/www-style/2012Feb/0270.html
- http://lists.w3.org/Archives/Public/www-style/2012Feb/0264.html
...
There is a [Disposition of Comments tool](https://wiki.csswg.org/tools/doc) to manage and present the Disposition of Comments
