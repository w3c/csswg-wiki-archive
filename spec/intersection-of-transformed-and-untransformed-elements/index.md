...
![](http://smfr.org/css/transforms/render-order-images/proposed.png) ![](http://smfr.org/css/transforms/render-order-images/proposed2.png)

#### Current renderings

WebKit/Chrome/Firefox:

![](http://smfr.org/css/transforms/render-order-images/webkit.png) ![](http://smfr.org/css/transforms/render-order-images/chrome.png) ![](http://smfr.org/css/transforms/render-order-images/firefox.png)
...
![](http://smfr.org/css/transforms/intersection-images/proposed.png)

#### Current renderings

WebKit, Firefox, Chrome:

![](http://smfr.org/css/transforms/intersection-images/current.png)
