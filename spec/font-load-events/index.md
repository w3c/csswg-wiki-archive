...
<title>@font-face Load Events - CSS Working Group Wiki (Archive)</title>
<style>
...
<div class="breadcrumb"><a href="../../">Home</a> / <a href="../../spec/">spec</a> / font-load-events</div>
<main>
<!-- TOC START -->
...
<ul class="toc">
<li class="level1"><a href="#font-face-load-events">@font-face Load Events</a><ul class="toc">
<li class="level2"><a href="#idl">IDL</a></li>
<li class="level2"><a href="#attributes">Attributes</a></li>
<li class="level2"><a href="#behavior">Behavior</a></li>
</ul></li>
</ul>
</div>
</div>
...
<h1 id="font-face-load-events">@font-face Load Events</h1>
<p>
...
<pre class="code">[Constructor(DOMString type, optional FontFaceEventInit eventInitDict)]
...
the attribute&#039;s value is the <abbr title="Cascading Style Sheets">CSS</abbr> serialization of that source.
Otherwise, the attribute&#039;s value is the value null.
</p><h2 id="behavior">Behavior</h2>
<p>
