...
- Self-review [creating a GitHub checklist in markdown](https://w3c.github.io/bp-i18n-specdev/#ghChecklist) (then paste it into an issue)
- [How to request I18n review](https://www.w3.org/International/review-request) (do the self review first)
- [How to engage with the i18n WG for assistance and reviews](https://www.w3.org/International/reviews/projReview.html)
