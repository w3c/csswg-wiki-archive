...
Proposal : Defer directional images to L4 in order to address [issue 37](http://lists.w3.org/Archives/Public/www-style/2012Mar/0243.html) (`ltr/rtl` annotations should be per-`image()` not per URL) and  [issue 41](http://lists.w3.org/Archives/Public/www-style/2012Mar/0397.html) (`ltr/rtl` annotations should be available via `image-orientation`)
