---
title: "Whiteboard for January 2012 LCWD"
---

# Whiteboard for January 2012 LCWD

This page is a status whiteboard for CSS3 Images. We needed a lot of whiteboard for the [Disposition of Comments](http://dev.w3.org/csswg/css3-images/issues-lc-2012).

The DoC lists important messages on www-style in the course of discussion. This page is listing the actions the WG needs to take to resolve the issues. See [these minutes](http://lists.w3.org/Archives/Public/www-style/2012Mar/0504.html) for the discussion and resolution of these issues.
...
| Overview | Kenny suggested treating media fragments as invalid images rather than requiring support in image(). This was rejected because the one major purpose of `image()` in this level is creating safe fallback behavior for authors [using Media Fragments for spriting](http://dev.w3.org/csswg/css3-images/#image-fragments). |
| Edits | However, for future media fragment extensions, we [added a clause](http://dev.w3.org/csswg/css3-images/#image-fallbacks) stating an unsupported media fragment syntax for a given image type makes the image invalid (triggering fallback to the next image in the `image()` list). |
...
**NOTE:** Tab has [removed out-of-document element references](http://lists.w3.org/Archives/Public/www-style/2012Mar/0477.html), which were the source of some of the more significant issues.
...
| Edits | [Added definition (new paragraph/list)](http://dev.w3.org/csswg/css3-images/#decorated-bounding-box) |
...
| Edits | [Syntax updated](http://dev.w3.org/csswg/css3-images/#image-notation), [defined when element() is invalid](http://dev.w3.org/csswg/css3-images/#element-reference). |
...
| Edits | Added definition ([new section](http://dev.w3.org/csswg/css3-images/#paint-sources)) |
|  |  |
...
| Edits | [Algo reworded](http://lists.w3.org/Archives/Public/www-style/2012Feb/0269.html) |
...
| Edits | Added third bullet in [cycle detection algorithm](http://dev.w3.org/csswg/css3-images/#element-cycles). |
...
| Edits | [Definition added](http://dev.w3.org/csswg/css3-images/#element-not-rendered) |
|  |  |
...
| Edits | ??? |
| Note | [Unclear](http://lists.w3.org/Archives/Public/www-style/2012Feb/1334.html) whether any edits were deemed necessary. No verification from commenter. |