---
title: "CSS Working Group 2008 Charter Table of Specifications"
---
...
Each module advocate is responsible for keeping the information on this page current. Instructions on how to maintain this page can be found [here](/planning/charter-2008-how-to/).
...
Status : CSS2.1 is currently a Candidate Recommendation. We are maintaining [errata](http://www.w3.org/Style/css2-updates/CR-CSS21-20070719-errata.html), a few of which are substantial but most of which are clarifications. We expect to publish a Last Call next followed shortly by another CR in order to incorporate the errata into the specification.
...
Advocate : Elika Etemad, ~~Paul Nelson~~, Sylvain Galineau [MSFT], Steve Zilles
...
Advocate : ~~Paul Nelson~~ Sylvain Galineau [MSFT], Elika Etemad, Steve Zilles
