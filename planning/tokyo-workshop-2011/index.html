====== Tokyo Workshop or Forum 2011 ======
  ...
  * 2011 June 1
  * at [[http://www.krp.co.jp/english/|Kyoto Research Park]], Kyoto, Japan
  * Organizer: NTT/W3C
  * See [[http://www.w3.org/Style/Japan-2011/]] for more up-to-date information.
...
Also we would like to see what kind of organization and/or mechanism would be suitable for improving the existing CSS specifications for Asian layout.

===== Scope / Audience =====
==== Expected Participants ====
  - CSS-WG participants
  - Stakeholders from related industries, e.g.:
...
Possible agenda topics include, but are not limited to the following:
  - Spec review of CSS3 specifications which is related to Asian layout capability, e.g., Writing Modes and Text
  - Presentations by Asin layout implementers and device vendors
  - Presentations by contents authors, e.g., Web pages, publishing, printing, digital signage
  - Panel discussions by all the key stakeholders

Note: The requirements and opinions of the CSS WG should be considered.

===== Dates =====
Note: Right before or right after the CSS WG F2F meeting in Japan on June 1-3 is 
