...
**We recommend you book your hotel room as soon as possible because we won't be able to keep these rooms for very long.** Reservation **must** be done using ![this form (docx format)](../../assets/images/planning/seoul2014-hotel-reservation-form.docx). It can be sent by email or fax. Please ping Daniel if you have any issue with the hotel using this form.
