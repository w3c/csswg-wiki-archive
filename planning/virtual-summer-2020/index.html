...
| Lea Verou | IE | yes | yes | yes | yes |
| Megan Gardner | Apple Inc | maybe | ✅ | ✅ | ✅ |
| Melanie Richards | Microsoft | No | No | Calling in for controls topics :) | No |
| Mike Bremford | BFO | first half | yes | yes | yes |
| Miriam Suzanne | Invited Expert | yes | yes | maybe/part | maybe/part |
| Myles C. Maxfield | Apple Inc | ✅ | ✅ | ✅ | ✅ |
| Oriol Brufau | Igalia | yes | yes | only 2nd half | yes |
