...
1. [text-spacing](http://dev.w3.org/csswg/css3-text/#text-spacing-prop) for proportional puncutation glyphs
1. [Current text-spacing](http://dev.w3.org/csswg/css3-text/#text-spacing-prop) and [the future text-spacing brainstorming](http://wiki.csswg.org/spec/text4#text-spacing) and line breaking?
...
1. Tightening up definitions of auto-sizing for multi-column elements in [orthogonal flows](http://dev.w3.org/csswg/css3-writing-modes/#orthogonal-flows) (particularly interactions with table layout).
1. [Flow-relative mappings](http://dev.w3.org/csswg/css3-writing-modes/#logical-direction-layout)
1. [text-orientation](http://dev.w3.org/csswg/css3-writing-modes/#text-orientation)
