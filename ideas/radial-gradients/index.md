...
- [The initial response to Brad's simplification proposal, in which Tab somewhat agrees with him](http://lists.w3.org/Archives/Public/www-style/2011Sep/0313.html)
- [A slightly later response in the same thread, where Tab explains why he now fully disagrees with Brad, and provides reasoning for keeping each of the features that Brad has cut in his proposal](http://lists.w3.org/Archives/Public/www-style/2011Sep/0562.html)
...
- [Detailed reasoning for wanting simplified syntax](http://lists.w3.org/Archives/Public/www-style/2011Sep/0019.html)
- ['circle' that covers (reply to dbaron's point)](http://lists.w3.org/Archives/Public/www-style/2011Oct/0419.html)
- [Update of proposal to include edge/corner-centering](http://lists.w3.org/Archives/Public/www-style/2011Oct/0334.html)
- ['cover'/'contain' syntax: it still requires multiplication factors](http://lists.w3.org/Archives/Public/www-style/2011Oct/0361.html)
- [We can still use radial gradients in list-style-image, but we shouldn't use that edge case as an excuse for complicating the syntax](http://lists.w3.org/Archives/Public/www-style/2011Oct/0470.html)
- [Simplicity is a virtue for CSS](http://lists.w3.org/Archives/Public/www-style/2011Oct/0341.html)
- [Recreating Brian's 'Spotlight' example, using simplified radial-gradient syntax and actual background properties](http://lists.w3.org/Archives/Public/www-style/2011Oct/0306.html) (instead of using background-like syntax inside radial-gradient)
...
<tbody>
<tr>
<td>[Similar Math for Both](http://www.bradclicks.com/cssplay/radial-equivelance.html)</td>
<td><code>radial-gradient(black 70.7%, red 70.7%, yellow)</code> or <code>radial-gradient(contain, black 100%, red 100%, yellow 141%)</code></td>
<td><code>radial-gradient(black 100%, red 100%, yellow 141%)</code></td>
</tr>
<tr>
<td>[Color stops based on image dimensions, with full coverage](http://www.bradclicks.com/cssplay/radial-gradient/OrangeCircle.png)</td>
<td><code>radial-gradient(red, black 35.35%, orange 35.35%, orange 70.7%, black 70.7%, red)</code> or <code>radial-gradient(contain, red, black 50%, orange 50%, orange 100%, black 100%, red 142%)</code></td>
<td><code>radial-gradient(red, black 50%, orange 50%, orange 100%, black 100%, red 142%)</code></td>
</tr>
<tr>
<td>[Quarter circle that goes full width](http://www.bradclicks.com/cssplay/impossible-radial-gradient.png)</td>
<td>Can't be done unless width is known. You can only make circles that size to the farthest side, whether it's horizontal or vertical.</td>
<td><code>radial-gradient(from top left, circle, yellow, red 100%, black 100%)</code></td>
</tr>
<tr>
<td>Hearts Grid</td>
...
background-position: &lt;set by script to the inverse of the mouse position&gt;;</code></pre></td>
</tr>
</tbody>
</table>