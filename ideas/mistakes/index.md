...
- We probably should have avoided mixing keywords (`span`) with idents in the [grid properties](https://github.com/w3c/csswg-drafts/issues/1137), possibly by using functional notation (like `span(2)`).
