...
- `printer-friendly-colors: <u>auto</u> | avoid`
- `printer-color-adjust: <u>auto</u> | avoid`
- `printer-colors: <u>auto</u> | exact`
- `color-adjust: <u>economy</u> | exact`
- `conserve-ink: <u>auto</u> | avoid`
- `expensive-colors: <u>adjust</u> | exact`
