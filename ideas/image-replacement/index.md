---
title: "Image Replacement in CSS3"
---
...
1. Otherwise download the font and use it, if possible.
1. Otherwise display the image in place of the contents, if possible.
1. Otherwise display the contents in an available font.
