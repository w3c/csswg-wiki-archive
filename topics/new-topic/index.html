...
Owner_tags    : @USER@          # Who's driving the discussion?
Status_tags   : Open            # [ Open | Resolved | Closed | Pending ] [, Urgent]?
Added_dt      : %G-%m-%d        # Date added as WG discussion request

Action        : What does the WG need to do? # Or, if Pending, pending what?
                # Some Examples:
