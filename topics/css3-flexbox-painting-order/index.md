...
<title>Painting Order of Reordered Flexbox Items - CSS Working Group Wiki (Archive)</title>
<style>
...
<div class="breadcrumb"><a href="../../">Home</a> / <a href="../../topics/">topics</a> / css3-flexbox-painting-order</div>
<main>
<h1 id="painting-order-of-reordered-flexbox-items">Painting Order of Reordered Flexbox Items</h1>
<div class="inline dataplugin_entry  sectionedit2"><dl><dt class="spec">Spec<span class="sep">: </span></dt><dd class="spec"><a href="../../spec?dataflt%5B0%5D=spec_%3Dcss3-flexbox" title="Show pages matching 'css3-flexbox'">css3-flexbox</a></dd><dt class="owner">Owner<span class="sep">: </span></dt><dd class="owner"><a href="../../owner?dataflt%5B0%5D=owner_%3Dtabatkins" title="Show pages matching 'tabatkins'">tabatkins</a></dd><dt class="status">Status<span class="sep">: </span></dt><dd class="status"><a href="../../status?dataflt%5B0%5D=status_%3DClosed" title="Show pages matching 'Closed'">Closed</a></dd><dt class="added">Added<span class="sep">: </span></dt><dd class="added">2012-05-16</dd><dt class="action">Action<span class="sep">: </span></dt><dd class="action">Pick A or B</dd></dl></div><h4 id="background">Background</h4>
<p>
...
<p>
<code>&lt;flexbox&gt;
  &lt;a style=“flex-order:2;”&gt;foo&lt;/a&gt;
  &lt;b style=“flex-order:1;”&gt;bar&lt;/b&gt;
&lt;/flexbox&gt;</code>
</p>
...
<ol>
<li class="level1">WebKit&#039;s implementation chooses option A.</li>
</ol>
</main>
</body>
</html>
