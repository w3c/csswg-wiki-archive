...
Status_tags   : Closed
Added_dt      : 2012-05-16
Action        : Pick proposal A, B, or C
Issue_urls    : http://lists.w3.org/Archives/Public/www-style/2012May/0554.html
Proposal_urls : 
...
Proposal 0 (current spec) : `justify` vs. `distribute`

Proposal A : `distribute` vs. `distribute-space`

Proposal B : `distribute-flush` vs. `distribute-space`

Proposal C : `distribute` vs. `space`

#### Links to More Info

1. http://www.w3.org/TR/css3-ruby/#rubyalign
1. http://www.w3.org/TR/css3-background/#the-background-repeat
1. http://www.w3.org/TR/css3-text/#text-justify
