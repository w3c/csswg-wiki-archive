...
You can also use an image to link to another internal or external page by combining the syntax for links and [images](/#images_and_other_files/) (see below) like this:
  ...
  [![](../../assets/images/wiki/dokuwiki-128.png)](http://www.php.net)
...
Resize to given width and height((when the aspect ratio of the given width and height doesn't match that of the image, it will be cropped to the new ratio before resizing)): ![](../../assets/images/wiki/dokuwiki-128.png)

Resized external image:           ![](http://de3.php.net/images/php.gif)

  Real size:                        ![](../../assets/images/wiki/dokuwiki-128.png)
  Resize to given width:            ![](../../assets/images/wiki/dokuwiki-128.png)
  Resize to given width and height: ![](../../assets/images/wiki/dokuwiki-128.png)
  Resized external image:           ![](http://de3.php.net/images/php.gif)
...
**Example:**
  ...
  ![](../../assets/images/rss>http///slashdot.org/index.rss 5 author date 1h)
