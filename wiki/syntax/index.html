...
<title>Formatting Syntax - CSS Working Group Wiki (Archive)</title>
<style>
...
<div class="breadcrumb"><a href="../../">Home</a> / <a href="../../wiki/">wiki</a> / syntax</div>
<main>
<!-- TOC START -->
...
<ul class="toc">
<li class="level1"><a href="#formatting-syntax">Formatting Syntax</a><ul class="toc">
<li class="level2"><a href="#basic-text-formatting">Basic Text Formatting</a></li>
<li class="level2"><a href="#links">Links</a><ul class="toc">
<li class="level3"><a href="#external">External</a></li>
<li class="level3"><a href="#internal">Internal</a></li>
<li class="level3"><a href="#interwiki">Interwiki</a></li>
<li class="level3"><a href="#windows-shares">Windows Shares</a></li>
<li class="level3"><a href="#image-links">Image Links</a></li>
</ul>
</li>
<li class="level2"><a href="#footnotes">Footnotes</a></li>
<li class="level2"><a href="#sectioning">Sectioning</a><ul class="toc">
<li class="level3"><a href="#headline-level-3">Headline Level 3</a></li>
</ul>
</li>
<li class="level2"><a href="#images-and-other-files">Images and Other Files</a></li>
<li class="level2"><a href="#lists">Lists</a></li>
<li class="level2"><a href="#text-conversions">Text Conversions</a><ul class="toc">
<li class="level3"><a href="#text-to-image-conversions">Text to Image Conversions</a></li>
<li class="level3"><a href="#text-to-html-conversions">Text to HTML Conversions</a></li>
</ul>
</li>
<li class="level2"><a href="#quoting">Quoting</a></li>
<li class="level2"><a href="#tables">Tables</a></li>
<li class="level2"><a href="#no-formatting">No Formatting</a></li>
<li class="level2"><a href="#code-blocks">Code Blocks</a><ul class="toc">
<li class="level3"><a href="#syntax-highlighting">Syntax Highlighting</a></li>
<li class="level3"><a href="#downloadable-code-blocks">Downloadable Code Blocks</a></li>
</ul>
</li>
<li class="level2"><a href="#embedding-html-and-php">Embedding HTML and PHP</a></li>
<li class="level2"><a href="#rssatom-feed-aggregation">RSS/ATOM Feed Aggregation</a></li>
<li class="level2"><a href="#control-macros">Control Macros</a></li>
<li class="level2"><a href="#syntax-plugins">Syntax Plugins</a></li>
</ul></li>
</ul>
</div>
</div>
...
<h1 id="formatting-syntax">Formatting Syntax</h1>
<p>
<a href="https://www.dokuwiki.org/DokuWiki" class="interwiki iw_doku" title="https://www.dokuwiki.org/DokuWiki">DokuWiki</a> supports some simple markup language, which tries to make the datafiles to be as readable as possible. This page contains all possible syntax you may use when editing the pages. Simply have a look at the source of this page by pressing the <em>Edit this page</em> button at the top or bottom of the page. If you want to try something, just use the <a href="../../playground/playground/" title="playground:playground">playground</a> page. The simpler markup is easily accessible via <a href="https://www.dokuwiki.org/toolbar" class="interwiki iw_doku" title="https://www.dokuwiki.org/toolbar">quickbuttons</a>, too.
</p><h2 id="basic-text-formatting">Basic Text Formatting</h2>
<p>
...
<p>
External links are recognized automagically: <a href="http://www.google.com" title="http://www.google.com" rel="noopener">http://www.google.com</a> or simply <a href="http://www.google.com" title="http://www.google.com" rel="noopener">www.google.com</a> - You can set the link text as well: <a href="http://www.google.com" title="http://www.google.com" rel="noopener">This Link points to google</a>. Email addresses like this one: <a href="mailto:&#97;&#110;&#100;&#105;&#64;&#115;&#112;&#108;&#105;&#116;&#98;&#114;&#97;&#105;&#110;&#46;&#111;&#114;&#103;" class="mail" title="&#97;&#110;&#100;&#105;&#64;&#115;&#112;&#108;&#105;&#116;&#98;&#114;&#97;&#105;&#110;&#46;&#111;&#114;&#103;">&#97;&#110;&#100;&#105;&#64;&#115;&#112;&#108;&#105;&#116;&#98;&#114;&#97;&#105;&#110;&#46;&#111;&#114;&#103;</a> are recognized, too.
</p>
...
addresses like this one: &lt;andi@splitbrain.org&gt; are recognized, too.</pre><h3 id="internal">Internal</h3>
<p>
Internal links are created by using square brackets. You can either just give a <a href="../../wiki/pagename/" title="wiki:pagename" rel="nofollow">pagename</a> or use an additional <a href="../../wiki/pagename/" title="wiki:pagename" rel="nofollow">link text</a>.
</p>
...
<p>
You can use <a href="../../some/namespaces/" title="some:namespaces" rel="nofollow">namespaces</a> by using a colon in the pagename.
</p>
...
<p>
Linking to a specific section is possible, too. Just add the section name behind a hash character as known from <abbr title="HyperText Markup Language">HTML</abbr>. This links to <a href="../../wiki/syntax#internal" title="wiki:syntax">this Section</a>.
</p>
...
<ul>
<li class="level1">Links to <a href="../../wiki/syntax/" title="wiki:syntax">existing pages</a> are shown in a different style from <a href="../../wiki/nonexisting/" title="wiki:nonexisting" rel="nofollow">nonexisting</a> ones.</li>
<li class="level1">DokuWiki does not use <a href="https://en.wikipedia.org/wiki/CamelCase" class="interwiki iw_wp" title="https://en.wikipedia.org/wiki/CamelCase">CamelCase</a> to automatically create links by default, but this behavior can be enabled in the <a href="https://www.dokuwiki.org/config" class="interwiki iw_doku" title="https://www.dokuwiki.org/config">config</a> file. Hint: If DokuWiki is a link, then it&#039;s enabled.</li>
<li class="level1">When a section&#039;s heading is changed, its bookmark changes, too. So don&#039;t rely on section linking too much.</li>
</ul><h3 id="interwiki">Interwiki</h3>
<p>
...
For example this is a link to Wikipedia&#039;s page about Wikis: [[wp&gt;Wiki]].</pre><h3 id="windows-shares">Windows Shares</h3>
<p>
...
<ul>
<li class="level1">For security reasons direct browsing of windows shares only works in Microsoft Internet Explorer per default (and only in the “local zone”).</li>
<li class="level1">For Mozilla and Firefox it can be enabled through different workaround mentioned in the <a href="http://kb.mozillazine.org/Links_to_local_pages_do_not_work" title="http://kb.mozillazine.org/Links_to_local_pages_do_not_work" rel="noopener">Mozilla Knowledge Base</a>. However, there will still be a JavaScript warning about trying to open a Windows Share. To remove this warning (for all users), put the following line in <code>conf/local.protected.php</code>:</li>
</ul>
<pre class="code">$lang[&#039;js&#039;][&#039;nosmblinks&#039;] = &#039;&#039;;</pre><h3 id="image-links">Image Links</h3>
<p>
You can also use an image to link to another internal or external page by combining the syntax for links and <a href="#images_and_other_files" title="wiki:syntax ↵">images</a> (see below) like this:
</p>
<pre class="code">[[http://www.php.net|{{wiki:dokuwiki-128.png}}]]</pre>

<p>
<a href="http://www.php.net" class="media" title="http://www.php.net" rel="noopener"><img src="/_media/wiki/dokuwiki-128.png" class="media" loading="lazy" alt="" /></a>
</p>
...
<p>
The whole <a href="#images_and_other_files" title="wiki:syntax ↵">image</a> and <a href="#links" title="wiki:syntax ↵">link</a> syntax is supported (including image resizing, internal and external images and URLs and interwiki links).
...
<pre class="code">You can add footnotes ((This is a footnote)) by using double parentheses.</pre><h2 id="sectioning">Sectioning</h2>
<p>
...
</p><h3 id="headline-level-3">Headline Level 3</h3><h4 id="headline-level-4">Headline Level 4</h4><h5 id="headline-level-5">Headline Level 5</h5>
...
<hr /><h2 id="images-and-other-files">Images and Other Files</h2>
<p>
You can include external and internal <a href="https://www.dokuwiki.org/images" class="interwiki iw_doku" title="https://www.dokuwiki.org/images">images</a> with curly brackets. Optionally you can specify the size of them.
</p>
...
<p>
Resize to given width:            <a href="/_detail/wiki/dokuwiki-128.png?id=wiki%3Asyntax" class="media" title="wiki:dokuwiki-128.png"><img src="/_media/wiki/dokuwiki-128.png?w=50&amp;tok=87a099" class="media" loading="lazy" alt="" width="50" /></a>
</p>

<p>
Resize to given width and height<sup><a href="#fn__2" id="fnt__2" class="fn_top">2)</a></sup>: <a href="/_detail/wiki/dokuwiki-128.png?id=wiki%3Asyntax" class="media" title="wiki:dokuwiki-128.png"><img src="/_media/wiki/dokuwiki-128.png?w=200&amp;h=50&amp;tok=d773f6" class="media" loading="lazy" alt="" width="200" height="50" /></a>
</p>

<p>
Resized external image:           <a href="../../lib/exe/fetch.php?tok=30bc05&amp;media=http%3A%2F%2Fde3.php.net%2Fimages%2Fphp.gif" class="media" title="http://de3.php.net/images/php.gif"><img src="/lib/exe/fetch.php?w=200&amp;h=50&amp;tok=c6b89d&amp;media=http%3A%2F%2Fde3.php.net%2Fimages%2Fphp.gif" class="media" loading="lazy" alt="" width="200" height="50" /></a>
</p>
...
<p>
For linking an image to another page see <a href="#image-links" title="wiki:syntax ↵">Image Links</a> above.
...
<ul>
<li class="level1">This is a list</li>
<li class="level1 node">The second item<ul>
<li class="level2">You may have different levels</li>
</ul>
</li>
<li class="level1">Another item</li>
</ul>
<ol>
<li class="level1">The same list but ordered</li>
<li class="level1 node">Another item<ol>
<li class="level2">Just use indention for deeper levels</li>
</ol>
</li>
<li class="level1">That&#039;s it</li>
</ol>
...
</p><h2 id="text-conversions">Text Conversions</h2>
<p>
...
</p><h3 id="text-to-image-conversions">Text to Image Conversions</h3>
<p>
...
<ul>
<li class="level1"><img src="/lib/images/smileys/cool.svg" class="icon smiley" alt="8-)" />   8-)</li>
<li class="level1"><img src="/lib/images/smileys/eek.svg" class="icon smiley" alt="8-O" />   8-O</li>
<li class="level1"><img src="/lib/images/smileys/sad.svg" class="icon smiley" alt=":-(" />   :-(</li>
<li class="level1"><img src="/lib/images/smileys/smile.svg" class="icon smiley" alt=":-)" />   :-)</li>
<li class="level1"><img src="/lib/images/smileys/smile2.svg" class="icon smiley" alt="=)" />    =)</li>
<li class="level1"><img src="/lib/images/smileys/doubt.svg" class="icon smiley" alt=":-/" />   :-/</li>
<li class="level1"><img src="/lib/images/smileys/doubt2.svg" class="icon smiley" alt=":-\" />   :-\</li>
<li class="level1"><img src="/lib/images/smileys/confused.svg" class="icon smiley" alt=":-?" />   :-?</li>
<li class="level1"><img src="/lib/images/smileys/biggrin.svg" class="icon smiley" alt=":-D" />   :-D</li>
<li class="level1"><img src="/lib/images/smileys/razz.svg" class="icon smiley" alt=":-P" />   :-P</li>
<li class="level1"><img src="/lib/images/smileys/surprised.svg" class="icon smiley" alt=":-O" />   :-O</li>
<li class="level1"><img src="/lib/images/smileys/silenced.svg" class="icon smiley" alt=":-X" />   :-X</li>
<li class="level1"><img src="/lib/images/smileys/neutral.svg" class="icon smiley" alt=":-|" />   :-|</li>
<li class="level1"><img src="/lib/images/smileys/wink.svg" class="icon smiley" alt=";-)" />   ;-)</li>
<li class="level1"><img src="/lib/images/smileys/fun.svg" class="icon smiley" alt="^_^" />   ^_^</li>
<li class="level1"><img src="/lib/images/smileys/question.svg" class="icon smiley" alt=":?:" />   :?:</li>
<li class="level1"><img src="/lib/images/smileys/exclaim.svg" class="icon smiley" alt=":!:" />   :!:</li>
<li class="level1"><img src="/lib/images/smileys/lol.svg" class="icon smiley" alt="LOL" />   LOL</li>
<li class="level1"><img src="/lib/images/smileys/fixme.svg" class="icon smiley" alt="FIXME" />   FIXME</li>
<li class="level1"><img src="/lib/images/smileys/deleteme.svg" class="icon smiley" alt="DELETEME" />  DELETEME</li>
</ul><h3 id="text-to-html-conversions">Text to HTML Conversions</h3>
<p>
Typography: <a href="../../wiki/dokuwiki/" title="wiki:dokuwiki">DokuWiki</a> can convert simple text characters to their typographically correct entities. Here is an example of recognized characters.
</p>
...
</div></blockquote><h2 id="tables">Tables</h2>
<p>
...
</p><h2 id="no-formatting">No Formatting</h2>
<p>
...
This is some text which contains addresses like this: http://www.splitbrain.org and **formatting**, but nothing is done with it.
&lt;/nowiki&gt;
The same is true for %%//__this__ text// with a smiley ;-)%%.</pre><h2 id="code-blocks">Code Blocks</h2>
<p>
...
&lt;/file&gt;</pre><h3 id="syntax-highlighting">Syntax Highlighting</h3>
<p>
<a href="../../wiki/dokuwiki/" title="wiki:dokuwiki">DokuWiki</a> can highlight sourcecode, which makes it easier to read. It uses the <a href="http://qbnz.com/highlighter/" title="http://qbnz.com/highlighter/" rel="noopener">GeSHi</a> Generic Syntax Highlighter – so any language supported by GeSHi is supported. The syntax is the same like in the code and file blocks in the previous section, but this time the name of the used language is inserted inside the tag. Eg. <code>&lt;code java&gt;</code> or <code>&lt;file java&gt;</code>.
</p>
...
</p><h3 id="downloadable-code-blocks">Downloadable Code Blocks</h3>
<p>
...
</p><h2 id="embedding-html-and-php">Embedding HTML and PHP</h2>
<p>
...
</p><h2 id="rssatom-feed-aggregation">RSS/ATOM Feed Aggregation</h2>
<p>
<a href="../../wiki/dokuwiki/" title="wiki:dokuwiki">DokuWiki</a> can integrate data from external XML feeds. For parsing the XML feeds, <a href="http://simplepie.org/" title="http://simplepie.org/" rel="noopener">SimplePie</a> is used. All formats understood by SimplePie can be used in DokuWiki as well. You can influence the rendering by multiple additional space separated parameters:
</p>
...
The refresh period defaults to 4 hours. Any value below 10 minutes will be treated as 10 minutes. <a href="../../wiki/dokuwiki/" title="wiki:dokuwiki">DokuWiki</a> will generally try to supply a cached version of a page, obviously this is inappropriate when the page contains dynamic external content. The parameter tells <a href="../../wiki/dokuwiki/" title="wiki:dokuwiki">DokuWiki</a> to re-render the page if it is more than <em>refresh period</em> since the page was last rendered.
</p>
...
<ul class="rss"><li><a href="https://tech.slashdot.org/story/26/02/13/191242/detroit-automakers-take-50-billion-hit?utm_source=rss1.0mainlinkanon&amp;utm_medium=feed" title="https://tech.slashdot.org/story/26/02/13/191242/detroit-automakers-take-50-billion-hit?utm_source=rss1.0mainlinkanon&amp;utm_medium=feed" rel="noopener">Detroit Automakers Take $50 Billion Hit</a> by msmash (2026/02/13 15:30)</li><li><a href="https://tech.slashdot.org/story/26/02/13/1929209/metas-new-patent-an-ai-that-likes-comments-and-messages-for-you-when-youre-dead?utm_source=rss1.0mainlinkanon&amp;utm_medium=feed" title="https://tech.slashdot.org/story/26/02/13/1929209/metas-new-patent-an-ai-that-likes-comments-and-messages-for-you-when-youre-dead?utm_source=rss1.0mainlinkanon&amp;utm_medium=feed" rel="noopener">Meta&#039;s New Patent: an AI That Likes, Comments and Messages For You When You&#039;re Dead</a> by msmash (2026/02/13 13:30)</li><li><a href="https://tech.slashdot.org/story/26/02/13/1844218/google-warns-eu-risks-undermining-own-competitiveness-with-tech-sovereignty-push?utm_source=rss1.0mainlinkanon&amp;utm_medium=feed" title="https://tech.slashdot.org/story/26/02/13/1844218/google-warns-eu-risks-undermining-own-competitiveness-with-tech-sovereignty-push?utm_source=rss1.0mainlinkanon&amp;utm_medium=feed" rel="noopener">Google Warns EU Risks Undermining Own Competitiveness With Tech Sovereignty Push</a> by msmash (2026/02/13 12:31)</li><li><a href="https://developers.slashdot.org/story/26/02/13/1834228/spotify-says-its-best-developers-havent-written-a-line-of-code-since-december-thanks-to-ai?utm_source=rss1.0mainlinkanon&amp;utm_medium=feed" title="https://developers.slashdot.org/story/26/02/13/1834228/spotify-says-its-best-developers-havent-written-a-line-of-code-since-december-thanks-to-ai?utm_source=rss1.0mainlinkanon&amp;utm_medium=feed" rel="noopener">Spotify Says Its Best Developers Haven&#039;t Written a Line of Code Since December, Thanks To AI</a> by msmash (2026/02/13 11:30)</li><li><a href="https://slashdot.org/story/26/02/13/1757219/ftc-ratchets-up-microsoft-probe-queries-rivals-on-cloud-ai?utm_source=rss1.0mainlinkanon&amp;utm_medium=feed" title="https://slashdot.org/story/26/02/13/1757219/ftc-ratchets-up-microsoft-probe-queries-rivals-on-cloud-ai?utm_source=rss1.0mainlinkanon&amp;utm_medium=feed" rel="noopener">FTC Ratchets Up Microsoft Probe, Queries Rivals on Cloud, AI</a> by msmash (2026/02/13 10:31)</li></ul><h2 id="control-macros">Control Macros</h2>
<p>
...
</table></div><h2 id="syntax-plugins">Syntax Plugins</h2>
<p>
...
<ul>
<li class="level1"><a href="https://www.dokuwiki.org/plugin:data" title="https://www.dokuwiki.org/plugin:data" rel="noopener">Structured Data Plugin</a> <em>2024-01-30</em> by <a href="mailto:&#97;&#110;&#100;&#105;&#64;&#115;&#112;&#108;&#105;&#116;&#98;&#114;&#97;&#105;&#110;&#46;&#111;&#114;&#103;" class="mail" title="&#97;&#110;&#100;&#105;&#64;&#115;&#112;&#108;&#105;&#116;&#98;&#114;&#97;&#105;&#110;&#46;&#111;&#114;&#103;">Andreas Gohr</a><br/>
Add and query structured data in your wiki</li>
<li class="level1"><a href="https://www.dokuwiki.org/plugin:definitionlist" title="https://www.dokuwiki.org/plugin:definitionlist" rel="noopener">Definition List plugin</a> <em>2017-08-17</em> by <a href="mailto:&#99;&#104;&#114;&#105;&#115;&#64;&#106;&#97;&#108;&#97;&#107;&#97;&#105;&#46;&#99;&#111;&#46;&#117;&#107;" class="mail" title="&#99;&#104;&#114;&#105;&#115;&#64;&#106;&#97;&#108;&#97;&#107;&#97;&#105;&#46;&#99;&#111;&#46;&#117;&#107;">Chris Smith, LarsDW223</a><br/>
Add syntax for definition lists.</li>
<li class="level1"><a href="http://dokuwiki.org/plugin:info" title="http://dokuwiki.org/plugin:info" rel="noopener">Info Plugin</a> <em>2020-06-04</em> by <a href="mailto:&#97;&#110;&#100;&#105;&#64;&#115;&#112;&#108;&#105;&#116;&#98;&#114;&#97;&#105;&#110;&#46;&#111;&#114;&#103;" class="mail" title="&#97;&#110;&#100;&#105;&#64;&#115;&#112;&#108;&#105;&#116;&#98;&#114;&#97;&#105;&#110;&#46;&#111;&#114;&#103;">Andreas Gohr</a><br/>
Displays information about various DokuWiki internals</li>
<li class="level1"><a href="https://www.dokuwiki.org/plugin:note" title="https://www.dokuwiki.org/plugin:note" rel="noopener">Note Plugin</a> <em>2024-04-15</em> by <a href="mailto:&#99;&#111;&#110;&#116;&#114;&#105;&#98;&#64;&#97;&#110;&#97;&#101;&#108;&#46;&#101;&#117;" class="mail" title="&#99;&#111;&#110;&#116;&#114;&#105;&#98;&#64;&#97;&#110;&#97;&#101;&#108;&#46;&#101;&#117;">Anael Mobilia</a><br/>
Add Note/Important/Tip/Warning Capability (DIV+CSS box)</li>
</ul>
